...
public class Tester 
{
    // make uppercase objects for each set of files you wanna test
    // compare output files with what they should contain
    
         // print out correct ones in green, incorrect ones in red
